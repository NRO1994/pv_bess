...
def write_monte_carlo_csv(
    ...
    for it in mc_result.iterations:
        rows.append({
            ...
            "capex_factor_pv": fmt_float(it.capex_factor_pv),
            "capex_factor_bess": fmt_float(it.capex_factor_bess),
            "opex_factor_pv": fmt_float(it.opex_factor_pv),
            "opex_factor_bess": fmt_float(it.opex_factor_bess),
            "pv_availability_factor": fmt_float(it.pv_availability_factor),
